...
\addcontentsline{toc}{section}{Acesso ao sistema}
...
\addcontentsline{toc}{section}{Configuração do edital}
...
\addcontentsline{toc}{section}{Execução e acompanhamento}
...
\addcontentsline{toc}{section}{Administração da plataforma}
